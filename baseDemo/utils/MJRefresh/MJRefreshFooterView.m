...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = NSLocalizedString(@"pullRefresh_Pull", @"");
        self.releaseToRefreshText = NSLocalizedString(@"pullRefresh_Relesae", @"");
        self.refreshingText = NSLocalizedString(@"pullRefresh_Refreshing", @"");
    }
    return self;
}
