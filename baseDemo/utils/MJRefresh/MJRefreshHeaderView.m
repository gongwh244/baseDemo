...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = NSLocalizedString(@"dropdownRefresh_Pull", @"");
        self.releaseToRefreshText = NSLocalizedString(@"dropdownRefresh_Release", @"");
        self.refreshingText = NSLocalizedString(@"dropdownRefresh_Refreshing", @"");
    }
    return self;
}
...
- (void)updateTimeLabel
{
    ...
    // 3.显示日期
    self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"%@%@",NSLocalizedString(@"lastUpdated", nil),time];
}
